export class S3Error extends Error {
     ...
     */
    constructor(filePath: string, operation: string, originalError: Error, googleDriveFileId?: string) {
        super(`S3 Error during ${operation} for file path: ${filePath} - ${originalError.message}`);
        this.name = 'S3Error';
